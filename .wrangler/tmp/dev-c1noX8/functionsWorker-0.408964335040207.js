...
// .wrangler/tmp/bundle-07Vqpw/checked-fetch.js
...
// .wrangler/tmp/pages-6TtDnr/functionsWorker-0.408964335040207.mjs
  ...
  try {
    if (request.method === "GET") {
      ...
      if (!admin && (uid === "YShEywcksESsm9GnhILOOO3kj5h2" || uid === "j9wP7R0VAZYzoXRVpebzsTq3G9n2")) {
        ...
        await env.DB.prepare("INSERT INTO admins (uid, email) VALUES (?, ?)").bind(uid, "admin@komalisarees.com").run();
...
var ensureContactTable = /* @__PURE__ */ __name2(async (db) => {
  await db.prepare(`
...
// .wrangler/tmp/bundle-07Vqpw/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-07Vqpw/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.408964335040207.js.map
