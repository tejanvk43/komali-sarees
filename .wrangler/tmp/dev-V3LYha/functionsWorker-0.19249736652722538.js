...
// .wrangler/tmp/bundle-IeKKkM/checked-fetch.js
...
// .wrangler/tmp/pages-JG1pj7/functionsWorker-0.19249736652722538.mjs
...
async function onRequest(context) {
  ...
  try {
    if (request.method === "GET") {
      ...
      console.log(`[ADMIN_CHECK] Checking UID: "${uid}"`);
      if (!uid) return new Response("Missing id", { status: 400 });
      if (!env.DB) {
        console.warn("D1 DB binding missing in admins GET.");
        const isAdmin = uid === "j9wP7R0VAZYzoXRVpebzsTq3G9n2" || uid === "admin-mock-id" || uid === "YShEywcksESsm9GnhILOOO3kj5h2";
        console.log(`[ADMIN_CHECK] No DB. Mock check for "${uid}": ${isAdmin}`);
      ...
      console.log(`[ADMIN_CHECK] DB Result for "${uid}":`, admin);
...
var ensureFeedbackTable = /* @__PURE__ */ __name2(async (db) => {
  await db.prepare(`
...
var ensureOrdersTable = /* @__PURE__ */ __name2(async (db) => {
  await db.prepare(`
...
var ensureProductsTable = /* @__PURE__ */ __name2(async (db) => {
  await db.prepare(`
...
var ensureTagsTable = /* @__PURE__ */ __name2(async (db) => {
  await db.prepare(`
...
var ensureUsersTable = /* @__PURE__ */ __name2(async (db) => {
  await db.prepare(`
...
// .wrangler/tmp/bundle-IeKKkM/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-IeKKkM/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.19249736652722538.js.map
